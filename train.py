...
train_generator =train_datagen.flow_from_directory(r"C:\Users\GOWTHAM.S\Desktop\Mini_project_photos",target_size=(224,224),color_mode='rgb',batch_size=32,class_mode='categorical',shuffle=True)
